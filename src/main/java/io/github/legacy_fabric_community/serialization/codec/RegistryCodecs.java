...
import io.github.legacy_fabric_community.serialization.mixin.BiomeAccessor;
import io.github.legacy_fabric_community.serialization.mixin.BlockEntityAccessor;
...
public interface RegistryCodecs {
    ...
    class Converters {
        ...
        private static final Map<Biome, String> BIOME_OBJECT_STRING_MAP = Maps.newHashMap();
        private static final Map<String, Biome> BIOME_STRING_OBJECT_MAP = Maps.newHashMap();
        ...
        static {
            for (Biome biome : BiomeAccessor.getBiomes()) {
                ...
                BIOME_STRING_OBJECT_MAP.put(biome.name, biome);
            }
